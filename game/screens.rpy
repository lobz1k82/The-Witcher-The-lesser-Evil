...
screen about():
    ...
    use game_menu(_("Об игре"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Сделано в рамках проекта учеников 11 «В» класса с помощью {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only] под руководством Вышегородских Максима Геннадьевича.\n\n[renpy.license!t] \n Студия Arcane Realm Studios")
